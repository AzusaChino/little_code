...
public class CombinationSum {
    ...
    public static void main(String[] args) {
        CombinationSum combinationSum2040 = new CombinationSum();
        System.out.println(combinationSum2040.combinationSum(new int[]{1, 1, 2, 5, 6, 7, 10}, 8));
    }
